...
public class CustomRestExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  //                .getName();
  //
  //    var apiError = new ApiError(HttpStatus.BAD_REQUEST, "an error occurred with the inputs",
  // error);
  ...
  //      WebRequest request) {
  //    var error =
  //        String.format("Accepted content types for this resource: %s",
  // ex.getSupportedMediaTypes());
  //    var apiError = new ApiError(HttpStatus.UNSUPPORTED_MEDIA_TYPE, "Unsuported media type",
  // error);
